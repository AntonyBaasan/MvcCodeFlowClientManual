...
namespace MvcCodeFlowClientManual.Controllers
{
    ...
    public class AppController : Controller
    {
        ...
        public static string clientid
        {
            get
            {
                var value = Environment.GetEnvironmentVariable("clientid");
                if (string.IsNullOrEmpty(value))
                    value = ConfigurationManager.AppSettings["clientid"];
                return value;
            }
        }
        ...
        public static string clientsecret 
        {
            get
            {
                var value = Environment.GetEnvironmentVariable("clientsecret");
                if (string.IsNullOrEmpty(value))
                    value = ConfigurationManager.AppSettings["clientsecret"];
                return value;
            }
        }
